...
projectdf_z2019['underwater'] = np.nan
...
projectdf_z2019.to_csv(directory + '/results/projectedresults2019.csv')
...
projectdf_z2020['underwater'] = np.nan
...
plt.show()   
projectdf_z2020.to_csv(directory + '/results/projectedresults2020.csv')
...
projectdf_z2021['underwater'] = np.nan
...
projectdf_z2021.to_csv(directory + '/results/projectedresults2021.csv')
...
fig6, ax6 = plt.subplots(3, constrained_layout = True)
# fig6.tight_layout()
ax6[0].plot(projectdf_z2019.index, projectdf_z2019['z_normalized'], color = 'black', label='Camera Derived Stage')
ax6[0].plot(projectdf_z2019.index, projectdf_z2019['stage_filtered'], color = 'red', label='Pressure Transducer Stage')
ax6[0].grid(linestyle='dashed')
ax6[0].set_ylim(-5, 5)
ax6[0].set_xlim([datetime.date(2019, 6, 8), datetime.date(2019, 9, 8)])
ax6[0].xaxis.set_major_formatter(date_form)
...
ax6[1].set_ylim(-5, 5)
ax6[1].set_xlim([datetime.date(2020, 6, 8), datetime.date(2020, 9, 8)])
ax6[1].xaxis.set_major_formatter(date_form)
...
ax6[2].set_ylim(-5, 5)
ax6[2].set_xlim([datetime.date(2021, 6, 8), datetime.date(2021, 9, 8)])
ax6[2].xaxis.set_major_formatter(date_form)
ax6[2].tick_params(axis='both', which='major', direction='out', labelsize=10, width=2)

fig6.legend(bbox_to_anchor=(0.72,0))
# fig6.text(0.04, 0.5, 'Stage (m)', va='center', rotation='vertical')


plt.show()
fig6.savefig(directory + '/results/fig6.png', dpi = 600, bbox_inches='tight')
...
print('2019 lin regress values (3 hours): ' +' r squared:' + str(r_value19_hour) + ' std error:' + str(std_err19_hour))

below_water19 = projectdf_z2019_2[projectdf_z2019_2['underwater']==0]
above_water19 = projectdf_z2019_2[projectdf_z2019_2['underwater']==1]

slope19_hour, intercept19_hour, r_value19_hour, p_value19_hour, std_err19_hour = stats.linregress(below_water19['stage_filtered'],below_water19['z_normalized'])
print('Extrapolated 2019 lin regress values (3 hours): ' +' r squared:' + str(r_value19_hour) + ' std error:' + str(std_err19_hour))
slope19_hour, intercept19_hour, r_value19_hour, p_value19_hour, std_err19_hour = stats.linregress(above_water19['stage_filtered'],above_water19['z_normalized'])
print('orthorectifed 2019 lin regress values (3 hours): ' +' r squared:' + str(r_value19_hour) +' std error:' + str(std_err19_hour))
...
projectdf_z2019_3 = projectdf_z2019.dropna()

slope19_day, intercept19_day, r_value19_day, p_value19_day, std_err19_day = stats.linregress(projectdf_z2019_3['bubbler_resampled'],projectdf_z2019_3['z_resampled'])
print('2019 lin regress values (days): ' + ' r squared:' + str(r_value19_day) +' std error:' + str(std_err19_day))
...
print('2020 lin regress values (3 hours): '  +' r squared:' + str(r_value20_hour) + ' std error:' + str(std_err20_hour))

below_water20 = projectdf_z2020_2[projectdf_z2020_2['underwater']==0]
above_water20 = projectdf_z2020_2[projectdf_z2020_2['underwater']==1]

slope20_hour, intercept20_hour, r_value20_hour, p_value20_hour, std_err20_hour = stats.linregress(below_water20['stage_filtered'],below_water20['z_normalized'])
print('Extrapolated 2020 lin regress values (3 hours): ' + 'slope:'  +' r squared:' + str(r_value20_hour)  + ' std error:' + str(std_err20_hour))
slope20_hour, intercept20_hour, r_value20_hour, p_value20_hour, std_err20_hour = stats.linregress(above_water20['stage_filtered'],above_water20['z_normalized'])
print('orthorectifed 2020 lin regress values (3 hours): ' + 'slope:'  +' r squared:' + str(r_value20_hour)  + ' std error:' + str(std_err20_hour))
...
projectdf_z2020_3 = projectdf_z2020.dropna()

slope20_day, intercept20_day, r_value20_day, p_value20_day, std_err20_day = stats.linregress(projectdf_z2020_3['bubbler_resampled'],projectdf_z2020_3['z_resampled'])
print('2020 lin regress values (days): ' + 'slope:'  +' r squared:' + str(r_value20_day) +  ' std error:' + str(std_err20_day))
...
print('2021 lin regress values (3 hours): ' + ' r squared:' + str(r_value21_hour) + ' std error:' + str(std_err21_hour))

below_water21 = projectdf_z2021_2[projectdf_z2021_2['underwater']==0]
above_water21 = projectdf_z2021_2[projectdf_z2021_2['underwater']==1]

slope21_hour, intercept21_hour, r_value21_hour, p_value21_hour, std_err21_hour = stats.linregress(below_water21['stage_filtered'],below_water21['z_normalized'])
print('Extrapolated 2021 lin regress values (3 hours): ' +' r squared:' + str(r_value21_hour) + ' std error:' + str(std_err21_hour))
slope21_hour, intercept21_hour, r_value21_hour, p_value21_hour, std_err21_hour = stats.linregress(above_water21['stage_filtered'],above_water21['z_normalized'])
print('orthorectifed 2021 lin regress values (3 hours): '  +' r squared:' + str(r_value21_hour) +  ' std error:' + str(std_err21_hour))
...
projectdf_z2021_3 = projectdf_z2021.dropna()

slope21_day, intercept21_day, r_value21_day, p_value21_day, std_err21_day = stats.linregress(projectdf_z2021_3['bubbler_resampled'],projectdf_z2021_3['z_resampled'])
print('2021 lin regress values (days): ' + ' r squared:' + str(r_value21_day) +  ' std error:' + str(std_err21_day))
...
ax5[0,0].set_ylim(bottom = -0.5, top =4.5)
ax5[0,0].set_xlim(left = -0.5, right =4.5)
...
ax5[0,1].set_ylim(bottom = -0.5, top =4.5)
ax5[0,1].set_xlim(left =-0.5, right =4.5)
...
ax5[0,2].set_ylim(bottom = -0.5, top =4.5)
ax5[0,2].set_xlim(left = -0.5, right =4.5)
...
ax5[1,0].set_ylim(bottom = -0.5, top =4.5)
ax5[1,0].set_xlim(left = -0.5, right =4.5)
...
ax5[1,1].set_ylim(bottom =-0.5, top =4.5)
ax5[1,1].set_xlim(left = -0.5, right =4.5)
...
ax5[1,2].set_ylim(bottom = -0.5, top =4.5)
ax5[1,2].set_xlim(left = -0.5, right =4.5)
# ax5[1,2].set_title('2021 correlation')
# ax5[1,2].set_xlabel('Filtered Stage (m)')
# ax5[0,2].set_ylabel('Water level (m)')

fig5.text(0.5, 0.02, 'Pressure Transducer Stage (m)', ha='center')
fig5.text(0.04, 0.5, 'Camera Derived Stage (m)', va='center', rotation='vertical')
...
fig5.savefig(directory + '/results/fig5.png', dpi = 600)
plt.show()
